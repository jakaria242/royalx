          ...
          <SwiperSlide>
            ...
            >
              ...
              <div className="absolute bottom-[25%] left-[95px] z-[3] flex flex-col gap-[16px] font-playfair">
                <small data-swiper-parallax="-200" className="text-base text-white">
                  Luxury Hotel & Restaurant
                </small>
                <h2 data-swiper-parallax="-300" className="text-[28px] text-white leading-9">
                  Enjoy Your <span className="text-[#df8033]">Dream</span> Time
                  with <br />
                  <span className="text-[#df8033]">Luxury</span> Experience
                </h2>
                <p data-swiper-parallax="-400" className="text-[18px] text-white font-poppins">Call Now <span className="block text-[#df8033]">01905000715</span></p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
